...
// Check if we need to remove hover states completely to force ONLY scroll logic to matter
...
if (content.includes(oldProblemItem)) {
  ...
  console.log('Removed hover state and added opacity to inactive items');
} else {
