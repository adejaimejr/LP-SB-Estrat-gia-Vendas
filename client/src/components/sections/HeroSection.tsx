          ...
          <div className="flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-8">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-12 justify-center lg:justify-start relative z-20">
                <a href="https://wa.me/5592981112101?text=Oi, Samara! Quero agendar um diagnóstico do meu comercial. Quando podemos conversar?" target="_blank" rel="noreferrer" className="bg-[#C9A84C] text-[#0A0A0A] text-center font-bold px-8 py-4 rounded-full hover:bg-[#E2C873] transition-all duration-300 btn-primary-glow shadow-[0_4px_20px_rgba(201,168,76,0.2)]">
